...
# Completes the garden OIDC browser login so the deploy scripts can mint an ai-trust-1 admin
# kubeconfig. Re-run if Claude reports "adminkubeconfig failed / access expired".
