#!/bin/bash
# 5-bind-apis.sh — bind the AI Trust Platform APIExport into the consumer workspace (with permission claims).
...
ok "AI Trust Platform API bound + served in the consumer workspace"
